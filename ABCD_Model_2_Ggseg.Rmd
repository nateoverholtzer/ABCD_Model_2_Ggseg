...
atlas <- dk()
## Turn off if you want all 8 views (superior, inferior, lateral, and medial; right and left) vs 4 views (lateral and medial; right and left)
atlas$data$sf <- atlas$data$sf %>% filter(view %in% c("lateral", "medial")) 
